...
export default function BillingError({
  ...
  useEffect(() => {
    console.error('app/(app)/app/billing/error.tsx:', error);
  }, [error]);
  ...
  return (
    <div className="flex min-h-[50vh] items-center justify-center bg-background text-foreground">
      <div className="w-full max-w-md space-y-4 px-4 text-center">
        <h2 className="text-xl font-semibold text-foreground">Billing error</h2>
        <p className="text-sm text-muted-foreground">
          We couldn&apos;t load billing details right now. Your subscription is
          not affected.
        </p>
        {error.digest ? (
