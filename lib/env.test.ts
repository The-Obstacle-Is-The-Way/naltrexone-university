...
describe('env', () => {
  ...
  it('rejects uppercase TRUE for FREE_TRIAL_ENABLED (only lowercase true/false accepted)', async () => {
    vi.spyOn(console, 'error').mockImplementation(() => undefined);
    ...
    process.env.NEXT_PUBLIC_SKIP_CLERK = 'true';
    process.env.FREE_TRIAL_ENABLED = 'TRUE'; // uppercase is not accepted by z.enum
    delete process.env.CLERK_SECRET_KEY;
    delete process.env.NEXT_PUBLIC_CLERK_PUBLISHABLE_KEY;
    delete process.env.VERCEL_ENV;
  ...
  it('rejects whitespace-padded value for FREE_TRIAL_ENABLED', async () => {
    vi.spyOn(console, 'error').mockImplementation(() => undefined);
    ...
    process.env.NEXT_PUBLIC_SKIP_CLERK = 'true';
    process.env.FREE_TRIAL_ENABLED = ' true '; // whitespace-padded is not accepted by z.enum
    delete process.env.CLERK_SECRET_KEY;
    delete process.env.NEXT_PUBLIC_CLERK_PUBLISHABLE_KEY;
    delete process.env.VERCEL_ENV;
