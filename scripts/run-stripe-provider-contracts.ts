...
// The two trial-clock cases and nine Checkout client contract cases normally
// finish in under two minutes (the eleven-case run took 79 seconds locally). Five minutes bounds a stuck provider process
