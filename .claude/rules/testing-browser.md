...
- `use-practice-session-start.browser.spec.tsx`
...
**History components:**
- `history-sessions-tab.browser.spec.tsx`
- `use-history-sessions.browser.spec.tsx`
