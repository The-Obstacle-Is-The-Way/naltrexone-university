...
> **Companion doc:** [`QUESTION-FORMAT-SPEC.md`](./QUESTION-FORMAT-SPEC.md) — traces draft → import → MDX → seed → DB → UI behavior
>
> This is the canonical taxonomy reference. Runtime implementation is aligned; use this with `QUESTION-FORMAT-SPEC.md` for day-to-day validation.
...
- [x] Census report generated in app repo (`docs/content/reports/tag-census-2026-02-18.md`)
