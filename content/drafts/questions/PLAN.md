...
This repo does include local helper scripts such as `validate_questions.py` in the separate content repo, but `pnpm content:import:drafts -- --dry-run` in the app repo remains the canonical structural validation path.
