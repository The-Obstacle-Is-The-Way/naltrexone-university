...
| 2026-03-07 | Broader hardcoded-UI subtitle explicit-sizing drift split into [DEBT-283](../_archive/debt/debt-283-hardcoded-ui-typography-explicit-sizing-alignment.md) | Keeps this item scoped to Markdown/question-flow unification rather than general page/app typography cleanup |
