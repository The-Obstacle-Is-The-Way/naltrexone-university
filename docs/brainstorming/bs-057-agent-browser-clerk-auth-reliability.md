...
**Related:** [DEBT-322](../debt/debt-322-exam-action-bar-ux-polish.md), [DEBT-323](../_archive/debt/debt-323-agent-browser-react-click-failures.md), [agent-browser docs](../tooling/agent-browser.md), [testing infrastructure](../dev/testing-infrastructure.md)
