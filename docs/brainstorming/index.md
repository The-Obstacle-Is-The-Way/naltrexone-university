...
| ID | Title | Outcome |
|----|-------|---------|
| [BS-063](../_archive/brainstorming/bs-063-exam-review-reentry-state-confusion.md) | Exam Review Re-Entry State Confusion — untargeted `Review Answers` re-entry from Session Summary reuses the last-viewed question, making the same surface reopen with different visible button states | Archived 2026-04-17. Fully promoted to [DEBT-364](../debt/debt-364-post-exam-review-reentry-cursor-persistence.md) after independent code trace confirmed the cursor-persistence root cause. No remaining brainstorm scope; implementation tracked in DEBT-364. |
