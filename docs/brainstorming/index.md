...
| [BS-057](./bs-057-agent-browser-clerk-auth-reliability.md) | Agent-Browser Clerk Auth Reliability — native `agent-browser` auth/state reuse is unreliable for Clerk-protected `/app/*` routes; Playwright-authenticated CDP attach is the current working path | Active | [DEBT-322](../debt/debt-322-exam-action-bar-ux-polish.md) |
