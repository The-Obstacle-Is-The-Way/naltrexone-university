...
| [BS-041](./bs-041-feedback-display-content-vs-code-separation.md) | Feedback Display — Content vs Code Separation (3 problems: redundant choice text, clinical pearl spacing, section visual hierarchy) | Active | [DEBT-275](../debt/debt-275-bs033-residual-open-items.md) (C2, C3, F1) |
