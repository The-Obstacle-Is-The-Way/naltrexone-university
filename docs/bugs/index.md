...
| [BUG-155](bug-155-feedback-card-visual-overhaul.md) | Feedback Card Visual Overhaul — Verdict Badge, Correct Answer Display, Wrong-Answer Cards, Accessibility | P2 | Fixed (2026-02-26) |
| [BUG-157](bug-157-question-card-choice-button-visual-polish.md) | Question Card and Choice Button Visual Polish — Text Size, Spacing, Contrast, Post-Submit Indicators | P2 | Fixed (2026-02-26) |
