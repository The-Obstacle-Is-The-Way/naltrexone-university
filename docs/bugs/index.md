...
|----|-------|----------|--------|---------|
| [BUG-304](./bug-304-practice-session-start-no-navigation.md) | Practice session Start can click without navigation or error | P3 | Open | The original no-navigation event remains unproven; promotion run `32903291145` separately proved the first diagnostic helper could misclassify a successful navigation when alert collection lost its execution context, and a red-first follow-up awaits review and production proof. |
