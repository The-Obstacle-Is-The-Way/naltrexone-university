...
- [BUG-254](./bug-254-active-exam-expiry-loses-local-selection.md) (P2) filed: active exam timer expiry can reject the final draft save and still finalize, turning a locally selected answer into an omitted incorrect attempt.
