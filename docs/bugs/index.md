...
PR #537 merged 2026-07-02 (`9711ca48`) with no other active bugs from that branch. The row below is the remaining active bug: BUG-281 from the 2026-07-05 post-Track-A adversarial database-seam review. BUG-276 from the 2026-06-30 sweep was resolved and archived 2026-07-08 after the PR #593 production proof; BUG-271/272/273/274/275 from that sweep were resolved and archived 2026-07-08 after the PR #587 production proof; BUG-277/278/279/280/282 were resolved and archived after PR #562/#563 plus the PR #564 production proof.

| Bug | Severity | Component | Summary |
|-----|----------|-----------|---------|
| [BUG-281](bug-281-seed-reimport-rewrites-answer-key-under-graded-history.md) | P3 | Content pipeline / seed / review integrity | Seed re-import's choice upsert could rewrite `choices.is_correct` under graded history; owner chose BLOCK, so the fix in progress refuses key flips over graded attempts or graded practice-session state unless an explicit `SEED_ALLOW_KEY_CHANGES_OVER_GRADED_HISTORY=true` override is set |
