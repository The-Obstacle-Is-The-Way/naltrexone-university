...
*(Forward pointer: the 2026-08-26 Latest stanza records the clean exact-head and post-merge receipts; only owner containment remains.)*
...
*(Forward pointer: those delivery receipts completed on 2026-08-26; the Latest stanza retains BUG-306 for the unproven cause and owner backlog disposition.)*
...
| [BUG-305](./bug-305-clerk-dev-browser-credential-in-ci-logs.md) | Clerk dev-browser credential appears in public CI logs | P2 | Open | The redaction fix is promoted and two exact-tree hosted runs have zero raw credential assignments; exposed-session expiry/revocation and separate historical-log containment remain owner actions. |
| [BUG-306](./bug-306-required-e2e-clerk-session-loss-and-accumulation.md) | Required E2E can lose Clerk session and accumulates sessions | P3 | Open | Suite session reuse/cleanup and bounded diagnostics are promoted and production-verified; the original auth-loss cause remains unproven and the historical TEST-session backlog still needs an owner disposition. |
