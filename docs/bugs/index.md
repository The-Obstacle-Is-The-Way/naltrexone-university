...
PR #537 merged 2026-07-02 (`9711ca48`) with no other active bugs from that branch. The 6 rows below are unrelated, from a separate 2026-06-30 sweep (see "Latest sweep (2026-06-30)" above) that was in flight at the same time and renumbered twice to avoid colliding with BUG-265..270 above:
