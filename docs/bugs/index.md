...
**Last Updated:** 2026-07-14 — **Fix-wave-3 close: BUG-296, BUG-297, BUG-298, and BUG-299 are resolved, production-verified, and archived.** Fixes shipped through PR #646 (squash `979a3666`) → promo #648, PR #651 (squash `6c01187b`) → promo #649, PR #647 plus follow-up #650 (squashes `b665d7ce`/`ba9ca86d`) → promo #649, and PR #652 (squash `175f35d8`) → promo #653. Each fix PR had CodeRabbit formal APPROVED review on its exact final head. Final main `76de5ba3` and dev were byte-identical at tree `c4fc04e0`; main CI run 29383288782 passed including deploy and a fresh close-time request to `addictionboards.com` returned HTTP/2 200. The 7-lens combined-diff review of `ba457afd...76de5ba3` confirmed three residues through 3-verifier panels: **BUG-300** (P4 premature retirement after a concurrent start result), **BUG-301** (P3 stale feedback completion clobbers a newer preserved key), and **DEBT-458** (P4 acknowledgement-failure error causality). Active bugs: BUG-300 and BUG-301. **Next Bug ID is BUG-302.** Prior detailed wave records remain below.
