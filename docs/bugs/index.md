...
|-----|--------|----------|---------|
| [BUG-258](bug-258-server-expired-draft-save-client-clock-skew-omits-selection.md) | Practice / exam clock / draft finalization | P3 | Server-expired draft-save failure can be ignored when the browser clock lags, leaving the selected answer local-only and later omitted |
...
| Bug | Severity | Component | Summary | Status |
|-----|----------|-----------|---------|--------|
| [BUG-258](bug-258-server-expired-draft-save-client-clock-skew-omits-selection.md) | P3 | Practice Engine / Exam Clock / Draft Finalization | Server-expired draft-save failure can be ignored when the browser clock lags, leaving the selected answer local-only and later omitted | Open |
