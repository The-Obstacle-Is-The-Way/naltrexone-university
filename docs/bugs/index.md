...
**6 new bugs filed (BUG-271..276) + 1 new debt item (DEBT-436)** *(BUG-271/272/273/274/275 resolved and archived 2026-07-08 after the PR #587 production proof — see Last Updated; only BUG-276 remains active from this sweep)*:
...
PR #537 merged 2026-07-02 (`9711ca48`) with no other active bugs from that branch. The rows below are the remaining active bugs: BUG-276 from the 2026-06-30 sweep (BUG-271/272/273/274/275 from that sweep were resolved and archived 2026-07-08 after the PR #587 production proof) and BUG-281 from the 2026-07-05 post-Track-A adversarial database-seam review (BUG-277/278/279/280/282 were resolved and archived after PR #562/#563 plus the PR #564 production proof):
