...
- [BUG-254](./bug-254-active-exam-expiry-loses-local-selection.md) (P2) in progress/pending fix: active exam timer expiry can reject the final draft save and still finalize, turning a locally selected answer into an omitted incorrect attempt. Phase 1 selected a bounded single-question server-side finalization flush and added the red browser regression.
