...
| Session Summary | `/app/practice/[sessionId]` after session completion | `SessionSummaryView` | None | Route exits to Practice / History; review handoff currently active work in [BS-061](../brainstorming/bs-061-review-surface-divergence-audit.md) | [BS-061](../brainstorming/bs-061-review-surface-divergence-audit.md) |
