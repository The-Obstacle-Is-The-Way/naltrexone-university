...
| Tonal row / direct-action target | Use the component-specific Pattern Registry entry. Dashboard-style in-card tonal rows use `hover:bg-foreground/[0.08]`; standalone tonal rows use `hover:bg-foreground/[0.12]`; choice buttons use `hover:bg-foreground/[0.08] hover:border-foreground/55` in light mode and `dark:hover:bg-foreground/8 dark:hover:border-foreground/55` on the unselected branch; filter chips use `hover:bg-foreground/[0.12] hover:border-foreground/60`. |
