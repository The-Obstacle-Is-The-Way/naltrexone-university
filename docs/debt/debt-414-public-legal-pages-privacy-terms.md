...
Resend activation, SHIELD adoption, owner read-through, and focused legal review remain explicit owner-tail items before paid acquisition; the provider-template classification item closed 2026-08-13. The Stage 1 public copy must not claim those controls are already active.
