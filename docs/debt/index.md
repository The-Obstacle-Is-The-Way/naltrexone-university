...
**Last Updated:** 2026-05-25 (DEBT-392 resolved across 14 PRs and archived; DEBT-393 added for Dependabot triage and config hardening; DEBT-394 added for supply-chain hardening via pnpm maturity gates, `strictDepBuilds` / `allowBuilds`, `blockExoticSubdeps`, `trustPolicy`, and a follow-on pnpm 11 migration.)
