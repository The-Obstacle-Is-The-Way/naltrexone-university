...
| [DEBT-308](./debt-308-e2e-review-mode-selector-regression.md) | E2E Review-Mode Audit Selector Regression — PR #206 removed `aria-label="Review question: ..."` from bookmark row links, breaking the E2E locator; CI E2E suite fails on every push | P1 | — |
