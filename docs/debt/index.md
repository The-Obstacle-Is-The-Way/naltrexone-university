...
| [DEBT-332](./debt-332-security-posture-audit.md) | Security posture audit — Clerk strict CSP is now running in report-only with Sentry reporting wired; deployed verification and eventual enforcing-mode rollout remain, no RLS (accepted architecture decision) | P2 | — |
