...
| [DEBT-338](./debt-338-seed-parser-silent-wrong-answer-section-corruption.md) | Seed parser silently accepts malformed `Why other answers are wrong` sections — **24 files confirmed corrupted** (23 clinical pearl contamination, 1 combined-label drop); Phase 1: strict validation on current parser; Phase 2: migrate authoring/import to structured YAML choice explanations and retire markdown parsing for per-choice feedback | P1 | — |
