...
| [DEBT-287](./debt-287-clinical-pearl-label-dark-mode-prominence.md) | Clinical Pearl Label Dark Mode Prominence — pearl label remains conspicuously recessed inside primary feedback content after DEBT-285 promotions; promote from `text-muted-foreground` to `text-foreground/60` | P3 | — |
