...
**Last Updated:** 2026-05-20 (DEBT-385 resolved and archived — PR #312 shipped Clover invoice subscription-ref extraction; `extractSubscriptionRef` now prefers the nested `data.object.parent.subscription_details.subscription` field while preserving root-level support for Checkout Session and older invoice payloads. main and dev synced at `6157bb1b`.)
