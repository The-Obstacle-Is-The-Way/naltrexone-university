...
| [DEBT-341](./debt-341-post-migration-legacy-path-removal.md) | Post-migration legacy path removal — deleted the legacy draft `answer` / `## Choices` importer path, removed `parseChoiceExplanations()` and its regex state machine, collapsed seed parsing to a single YAML path, and pruned the legacy-only tests | P2 | 2026-03-28 | [PR #256](https://github.com/The-Obstacle-Is-The-Way/naltrexone-university/pull/256) |
