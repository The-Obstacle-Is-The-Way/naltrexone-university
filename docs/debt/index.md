...
| [DEBT-285](./debt-285-feedback-explanation-dark-mode-readability.md) | Feedback Explanation Dark Mode Readability — promote feedback explanations to `text-base text-foreground`, bump the feedback reference from `text-xs` to `text-sm`, and document the feedback-context override | P2 | — |
