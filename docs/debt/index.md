...
| [DEBT-296](./debt-296-filter-section-summary-hierarchy-swap.md) | Filter Section Summary Text Hierarchy Swap — collapsed zero-state summaries now surface outcome copy (`All topics included by default`), while expanded sections show the current `({N} selected)` footer below the chips | P3 | 2026-03-09 | — |
