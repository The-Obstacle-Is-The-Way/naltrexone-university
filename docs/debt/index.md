...
|----|-------|----------|----------|--------------|
| [DEBT-361](./debt-361-exam-last-question-next-label.md) | Exam last question "Next" label doesn't reflect action — clicking "Next" on Q3/3 enters Review & Submit but label doesn't change; post-exam review correctly uses "Finish review" | P3 | 2026-04-11 | — |
