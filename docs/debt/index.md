...
| [DEBT-339](./debt-339-consolidate-question-instruction-files.md) | Consolidate 8 question instruction files → 5 (absorb QUESTION-FORMAT-SPEC.md + TAG-TAXONOMY.md into SCHEMA.md, redistribute META.MD deliberately, preserve active quality guidance and historical audits); prerequisite for DEBT-338 Phase 2 YAML migration | P2 | — |
