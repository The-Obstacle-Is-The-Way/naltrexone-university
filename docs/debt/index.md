...
|----|-------|----------|----------|--------------|
| [DEBT-360](../_archive/debt/debt-360-action-bar-below-fold.md) | Sticky action bar primitive shared by `PracticeView` and `PostExamReviewView`, using a viewport-bounded shell, scrollable content region, and safe-area footer treatment so primary controls stay visible on long questions/feedback | P2 | 2026-04-12 | PR pending |
