...
| [DEBT-289](./debt-289-dashboard-nested-card-surface-strategy.md) | Dashboard Nested Card Surface Strategy — the dashboard has a "bipolar" visual feel from flat stat cards (top) vs. card-in-card nested rows (bottom); needs a unified surface treatment for list-in-card contexts app-wide | P3 | — |
