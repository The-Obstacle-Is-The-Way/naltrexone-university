...
| [DEBT-285](./debt-285-feedback-explanation-dark-mode-readability.md) | Feedback Explanation Dark Mode Readability — promote explanation text to `text-base text-foreground`, bump reference from `text-xs` to `text-sm` | P2 | — |
