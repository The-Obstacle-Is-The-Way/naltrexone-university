...
**Last Updated:** 2026-05-05 (DEBT-378 resolved)
...
| [DEBT-379](./debt-379-exam-action-bar-promote-primary-cta-to-right-slot.md) | Exam action-bar candidate sequenced after DEBT-378: promote Next / Review & Submit to a footer right CTA group (`exam-action-cta-group`) and move Mark/Unmark review to the exam header rail (`question-header-actions`) while preserving `aria-pressed`, disabled state, and DEBT-361 `aria-describedby`. Corrects prior doc drift: DEBT-330 was post-exam review bookmark placement, DEBT-365 Concern 3A applied that grouping to active exam; DEBT-379 is a separate design call, not measured misclick evidence. Requires post-DEBT-378 visual grade before implementation. Estimated ~80-120 production LOC, ~30-50 assertions across 4-5 files | P3 | — |
