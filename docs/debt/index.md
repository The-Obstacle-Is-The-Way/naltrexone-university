...
|----|-------|----------|----------|--------------|
| [DEBT-356](../_archive/debt/debt-356-duplicate-question-surface-renderers.md) | Duplicate question-surface renderers — extracted shared `QuestionSurfaceBody` so `QuestionView` and `PracticeView` now share one question-card/feedback composition path while keeping surface-specific wrappers thin | P3 | 2026-04-10 | — |
