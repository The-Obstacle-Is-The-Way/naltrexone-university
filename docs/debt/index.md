...
| [DEBT-322](./debt-322-exam-action-bar-ux-polish.md) | Exam action bar UX polish — remove Q1 spacer (D-1), rename exit to "Finish exam" and heading to "Review & Submit" (D-2), footer always "Next" with onEndSession routing on last Q (D-3), stabilize Previous visibility from sessionInfo.index (D-4b). All frontend-only. | P2 | — |
