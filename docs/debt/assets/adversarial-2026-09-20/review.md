...
2. **CONFIRMED — implementation merged:** [DEBT-486](../../debt-486-import-seed-validation-disagreement.md) shared import/seed body validation landed in #949 before #952's static whole-input prevalidation. Its record retains the empty-stem/Reference regressions and exact-head approval; only the later release readback remains at the linked snapshot. Neither implementation depends on optional browser telemetry.
