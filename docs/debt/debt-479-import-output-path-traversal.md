# DEBT-479: Import Output Path Traversal
...
The same command supports the modes cited by DEBT-480 through DEBT-482.
...
- [DEBT-480: Import/seed disagreement](debt-480-import-seed-validation-disagreement.md)
- [DEBT-481: Silent omission](debt-481-draft-splitter-silent-omission.md)
