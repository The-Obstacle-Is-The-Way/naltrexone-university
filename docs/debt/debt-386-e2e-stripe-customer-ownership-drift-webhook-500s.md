...
4. Add `customer.subscription.created` to both webhook endpoint event lists. That is a separate Stripe Dashboard config step and should not be treated as the root cause of this debt.
