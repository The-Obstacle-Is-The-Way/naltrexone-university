...
that conclusion lives in a debt entry, and the Dependabot alert is
dismissed against that record rather than left to drift. The worked
precedent is `stream-json` in
