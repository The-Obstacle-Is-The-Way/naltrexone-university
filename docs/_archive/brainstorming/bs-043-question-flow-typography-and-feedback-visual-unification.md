...
**Related:** [DEBT-279](../debt/debt-279-wcag-aa-contrast-remediation-plan.md), [BS-042](./bs-042-contrast-consistency-and-wcag-compliance-audit.md), [BUG-155](../bugs/bug-155-feedback-card-visual-overhaul.md), [BUG-157](../bugs/bug-157-question-card-choice-button-visual-polish.md), [Pattern Registry](../../frontend/pattern-registry.md)
...
| 2026-03-07 | Broader hardcoded-UI subtitle explicit-sizing drift split into [DEBT-283](../debt/debt-283-hardcoded-ui-typography-explicit-sizing-alignment.md) | Keeps this item scoped to Markdown/question-flow unification rather than general page/app typography cleanup |
