...
Residuals filed from the wave-2 close review: [BUG-297](./bug-297-checkout-success-version-cas-exhaustion-uncaught-conflict.md) — the checkout-success call site's bounded-exhaustion display failure, now fixed and production-verified — and [DEBT-457](../debt/debt-457-wave2-determinacy-and-test-hygiene-residues.md) Item 2 — the webhook integration's per-attempt live Stripe retrieve doubles the steady-state API cost per subscription event.
