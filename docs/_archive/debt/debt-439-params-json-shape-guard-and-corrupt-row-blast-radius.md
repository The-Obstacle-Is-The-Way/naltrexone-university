...
- Development post-deploy proof for the subsequent `0028_repair_attempts_selected_choice_index` drift repair is pending this repair PR's Preview deployment; `0028` does not change the `params_json` CHECK, but the final proof records the full post-0028 ledger state.
