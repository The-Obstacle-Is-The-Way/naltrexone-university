...
**Related:** [Debt Index](../../debt/index.md) · [DEBT-391](./debt-391-local-e2e-schema-drift-preflight.md) (resolved/archived; a **distinct** failure mode — schema drift — detected in the E2E credential preflight, not in the reset helper) · [DEBT-410](../../debt/debt-410-free-trial-pathway-and-pricing-access-copy.md) (the PR that surfaced this) · `tests/e2e/helpers/reset-e2e-user-state.ts` · `playwright.config.ts` · `.github/workflows/ci.yml`
