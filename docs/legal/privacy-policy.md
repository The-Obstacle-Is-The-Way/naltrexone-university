...
> **2026-09-16 revision: production-verified 2026-09-17.** Findings F11-F13 in [the non-lawyer adversarial review](../debt/debt-414-public-legal-pages-privacy-terms.md#2026-09-16-non-lawyer-adversarial-pre-counsel-review) explain these copy corrections, and the [dated verification record](../debt/debt-414-public-legal-pages-privacy-terms.md#2026-09-17-revised-privacy-production-verification) holds the signed-out production measurement. The following publication record describes the earlier baseline, not this revision.
>
...
### 2026-09-16 copy correction record

Applied F11-F13 from the [non-lawyer adversarial review](../debt/debt-414-public-legal-pages-privacy-terms.md#2026-09-16-non-lawyer-adversarial-pre-counsel-review): describe active Resend and its actual subscription-message scope; remove completed owner checks from public copy; disclose the incident procedure's conditional Apple/iCloud and Bitwarden stores and incident-record retention; explain Stripe's cross-business processing. The analytics statement describes the current build and does not assert that historical collection never occurred. Earlier dated evidence above is preserved. The public date and typed-page mirror changed together; Terms version and hash did not change. Production verification of this revision remains pending deployment. *(Closed 2026-09-17: see the [dated verification record](../debt/debt-414-public-legal-pages-privacy-terms.md#2026-09-17-revised-privacy-production-verification).)*
