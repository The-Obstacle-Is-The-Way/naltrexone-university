...
| **Subscription and payment information** | Subscription status and plan; billing-period end; cancellation status; Stripe customer, subscription, checkout, and event identifiers; limited billing or payment-method details that Stripe makes available, such as card brand and last four digits |
