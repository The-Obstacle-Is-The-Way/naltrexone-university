...
**2026-09-22 — navigation view.** [DEBT-481](../debt/debt-481-master-spec-implementation-drift.md) replaces the independently maintained implementation copy with links to the master and each contract's authority. Product decisions remain in the master; this page adds no separate contract.
